...
jack_default_audio_sample_t* sin_buffer;
...
int main (int argc, char *argv[])
{
    ...
    sin_buffer = (jack_default_audio_sample_t*)malloc(1024 * sizeof (jack_default_audio_sample_t));
    for(int i=0; i < 1024; i++)
        sin_buffer[i] = 0.2*sin((float)i/1023.0*20*PI);
